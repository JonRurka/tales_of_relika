...
public:
	...
	static Item_Type* Get_ItemType(int type_id);
	static Item_Type* Get_ItemType(std::string type);
...
private:
	...
	static std::unordered_map<int, Item_Type*> m_types;
	static std::unordered_map<std::string, Item_Type*> m_name_map;
